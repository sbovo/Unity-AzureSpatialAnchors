...
namespace Microsoft.Azure.SpatialAnchors.Unity
{
    ...
    public class SpatialAnchorManager : MonoBehaviour
    {
        ...
        /// </param>
        private bool EnsureValidConfiguration(bool disable, bool exception)
        {
...
#pragma warning restore CS1998
        ...
        /// </returns>
        protected virtual bool IsValidateConfiguration()
        {
        ...
        protected virtual void Start()
        {
            ...
            EnsureValidConfiguration(disable: true, exception: false);
        }
